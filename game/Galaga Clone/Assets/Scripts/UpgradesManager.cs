...
public class UpgradesManager : MonoBehaviour
{
    ...
    //    string[] activeUpgrades = DataBaseManager.upgradesActive; //PlayerPrefs.GetString("activeUpgrades").Split('|');
    //    string[] unlockedUpgrades = DataBaseManager.upgradesUnlocked; //PlayerPrefs.GetString("unlockedUpgrades").Split('|');
